...
void loop() {
  ...
  if (mpu.dmpGetCurrentFIFOPacket(FIFOBuffer)) { 
      ...
      yawFilteredOutput = (yawFilterAlpha * yawOutput) + (1 - yawFilterAlpha) * yawFilteredOutput;
      ...
      rollFilteredOutput = (rollFilterAlpha * rollOutput) + (1 - rollFilterAlpha) * rollFilteredOutput;
